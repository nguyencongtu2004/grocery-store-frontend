...
export const api = {
  ...
  provider: {
    getAll: ({ page, itemsPerPage, keyword }) => `/providers?page=${page}&limit=${itemsPerPage}&keyword=${keyword ?? ""}`,
  ...
  category: {
    getAll: ({ page, itemsPerPage, keyword }) => `/categories?page=${page}&limit=${itemsPerPage}&name=${keyword ?? ""}`,
  ...
  discount: {
    getAll: ({ page, itemsPerPage, keyword }) => `/discounts?page=${page}&limit=${itemsPerPage}&keyword=${keyword ?? ""}`,
